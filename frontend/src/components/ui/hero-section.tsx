    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                ...
                <section>
                    <div className="relative isolate  pt-24 md:pt-36">
                        <DotPattern
                            width={24}
                            height={24}
                            cx={2}
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link to="#link">
                                                <span className="text-nowrap">Create Your First Workspace</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20 w-full">

                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <video
                                        className="bg-background aspect-15/8 relative w-full rounded-2xl"
                                        autoPlay
                                        muted
                                        loop
                                        playsInline
                                    >
                                        <source src="https://a.slack-edge.com/55e8901/marketing/img/homepage/revamped-25/hero/hp-hero.IN@2x.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
                        </AnimatedGroup>
