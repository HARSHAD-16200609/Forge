...
function InterfacesLogoSquare() {
    return (
        <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
            <div className="absolute aspect-[24/16] left-0 right-0 top-1/2 -translate-y-1/2 text-sidebar-foreground">
        ...
        <div className="relative shrink-0 w-full">
            <div className="flex items-center p-1 w-full">
                ...
                <div className="px-2 py-1">
                    <div className="font-['Lexend:SemiBold',_sans-serif] text-[16px] text-sidebar-foreground">
                        Interfaces
                    </div>
                </div>
            </div>
...
function AvatarCircle() {
    ...
    return (
        <div className="relative rounded-full shrink-0 size-8 bg-sidebar">
            <div className="flex items-center justify-center size-8">
                <Profile avatarUrl={user?.avatar} username={user?.username} />
            </div>
            <div
                aria-hidden="true"
                className="absolute inset-0 rounded-full border border-sidebar-border pointer-events-none"
            />
        </div>
    );
}
...
function SearchContainer({ isCollapsed = false }: { isCollapsed?: boolean }) {
    ...
    return (
        ...
        >
            <div
                className={`bg-sidebar h-10 relative rounded-lg flex items-center transition-all duration-500 ${isCollapsed ? "w-10 min-w-10 justify-center" : "w-full"
                    }`}
                style={{ transitionTimingFunction: softSpringEasing }}
            >
                <div
            ...
            sections: [
                {
                    ...
                    items: [
                        { icon: <View size={16} className="text-sidebar-foreground" />, label: "Overview", isActive: true },
                        {
                            icon: <Dashboard size={16} className="text-sidebar-foreground" />,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            icon: <StarFilled size={16} className="text-sidebar-foreground" />,
            ...
            sections: [
                {
                    title: "Quick Actions",
                    items: [
                        { icon: <AddLarge size={16} className="text-sidebar-foreground" />, label: "New task" },
                        { icon: <Filter size={16} className="text-sidebar-foreground" />, label: "Filter tasks" },
                    ],
                },
                {
                    title: "My Tasks",
                    items: [
                        {
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <Flag size={14} className="text-sidebar-foreground/70" />, label: "Review design mockups" },
                                { icon: <CheckmarkOutline size={14} className="text-sidebar-foreground/70" />, label: "Update documentation" },
                                { icon: <InProgress size={14} className="text-sidebar-foreground/70" />, label: "Test new feature" },
                            ],
                        },
                        {
                            icon: <InProgress size={16} className="text-sidebar-foreground" />,
                            label: "In progress",
                            hasDropdown: true,
                            children: [
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "Implement user auth" },
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "Database migration" },
                            ],
                        },
                        {
                            icon: <CheckmarkOutline size={16} className="text-sidebar-foreground" />,
                            label: "Completed",
                            hasDropdown: true,
                            children: [
                                { icon: <CheckmarkOutline size={14} className="text-sidebar-foreground/70" />, label: "Fixed login bug" },
                                { icon: <CheckmarkOutline size={14} className="text-sidebar-foreground/70" />, label: "Updated dependencies" },
                                { icon: <CheckmarkOutline size={14} className="text-sidebar-foreground/70" />, label: "Code review completed" },
                            ],
                        },
                    ],
                },
                {
                    ...
                    items: [
                        {
                            icon: <Flag size={16} className="text-sidebar-foreground" />,
                        ...
                        { icon: <Archive size={16} className="text-sidebar-foreground" />, label: "Archived" },
                    ],
                },
            ],
        },
            ...
            sections: [
                {
                    title: "Quick Actions",
                    items: [
                        { icon: <AddLarge size={16} className="text-sidebar-foreground" />, label: "New project" },
                        { icon: <Filter size={16} className="text-sidebar-foreground" />, label: "Filter projects" },
                    ],
                },
                {
                    ...
                    items: [
                        {
                            icon: <FolderOpen size={16} className="text-sidebar-foreground" />,
                            label: "Web Application",
                            hasDropdown: true,
                            children: [
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "Frontend development" },
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "API integration" },
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "Testing & QA" },
                            ],
                        },
                        {
                            icon: <FolderOpen size={16} className="text-sidebar-foreground" />,
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "UI/UX design" },
                                { icon: <Task size={14} className="text-sidebar-foreground/70" />, label: "Native development" },
                            ],
                        },
                    ],
                },
                {
                    title: "Other",
                    items: [
                        { icon: <CheckmarkOutline size={16} className="text-sidebar-foreground" />, label: "Completed" },
                        { icon: <Archive size={16} className="text-sidebar-foreground" />, label: "Archived" },
                    ],
                },
            ],
            ...
            sections: [
                {
                    title: "Views",
                    items: [
                        { icon: <View size={16} className="text-sidebar-foreground" />, label: "Month view" },
                        { icon: <CalendarIcon size={16} className="text-sidebar-foreground" />, label: "Week view" },
                        { icon: <Time size={16} className="text-sidebar-foreground" />, label: "Day view" },
                    ],
                },
                {
                    title: "Events",
                    items: [
                        {
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <UserMultiple size={14} className="text-sidebar-foreground/70" />, label: "Team standup (9:00 AM)" },
                                { icon: <UserIcon size={14} className="text-sidebar-foreground/70" />, label: "Client call (2:00 PM)" },
                                { icon: <UserMultiple size={14} className="text-sidebar-foreground/70" />, label: "Project review (4:00 PM)" },
                            ],
                        },
                        { icon: <CalendarIcon size={16} className="text-sidebar-foreground" />, label: "Upcoming events" },
                    ],
                },
                {
                    title: "Quick Actions",
                    items: [
                        { icon: <AddLarge size={16} className="text-sidebar-foreground" />, label: "New event" },
                        { icon: <Share size={16} className="text-sidebar-foreground" />, label: "Share calendar" },
                    ],
                },
            ],
        },
        ...
        teams: {
            ...
            sections: [
                    ...
                    items: [
                        {
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <UserIcon size={14} className="text-sidebar-foreground/70" />, label: "John Doe (Lead)" },
                                { icon: <UserIcon size={14} className="text-sidebar-foreground/70" />, label: "Jane Smith" },
                                { icon: <UserIcon size={14} className="text-sidebar-foreground/70" />, label: "Mike Johnson" },
                            ],
                        },
                        {
                            icon: <Group size={16} className="text-sidebar-foreground" />,
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <UserIcon size={14} className="text-sidebar-foreground/70" />, label: "Sarah Wilson" },
                                { icon: <UserIcon size={14} className="text-sidebar-foreground/70" />, label: "Tom Brown" },
                            ],
                        },
                    ],
                },
                {
                    title: "Quick Actions",
                    items: [
                        { icon: <AddLarge size={16} className="text-sidebar-foreground" />, label: "Invite member" },
                        { icon: <UserMultiple size={16} className="text-sidebar-foreground" />, label: "Manage teams" },
                    ],
                },
            ],
        },
            ...
            sections: [
                {
                    title: "Reports",
                    items: [
                        { icon: <Report size={16} className="text-sidebar-foreground" />, label: "Performance report" },
                        { icon: <ChartBar size={16} className="text-sidebar-foreground" />, label: "Task completion" },
                        { icon: <Analytics size={16} className="text-sidebar-foreground" />, label: "Team productivity" },
                    ],
                },
                {
                    title: "Insights",
                    items: [
                        {
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <CheckmarkOutline size={14} className="text-sidebar-foreground/70" />, label: "Tasks completed: 24" },
                                { icon: <Time size={14} className="text-sidebar-foreground/70" />, label: "Avg. completion time: 2.5d" },
                                { icon: <UserMultiple size={14} className="text-sidebar-foreground/70" />, label: "Team efficiency: 87%" },
                            ],
                        },
                    ],
                },
            ...
            sections: [
                {
                    title: "Quick Actions",
                    items: [
                        { icon: <CloudUpload size={16} className="text-sidebar-foreground" />, label: "Upload file" },
                        { icon: <AddLarge size={16} className="text-sidebar-foreground" />, label: "New folder" },
                    ],
                },
                {
                    title: "Recent Files",
                    items: [
                        {
                            icon: <DocumentAdd size={16} className="text-sidebar-foreground" />,
                            label: "Recent documents",
                            hasDropdown: true,
                            children: [
                                { icon: <DocumentAdd size={14} className="text-sidebar-foreground/70" />, label: "Project proposal.pdf" },
                                { icon: <DocumentAdd size={14} className="text-sidebar-foreground/70" />, label: "Meeting notes.docx" },
                                { icon: <DocumentAdd size={14} className="text-sidebar-foreground/70" />, label: "Design specs.figma" },
                            ],
                        },
                        { icon: <Share size={16} className="text-sidebar-foreground" />, label: "Shared with me" },
                    ],
                },
                {
                    title: "Organization",
                    items: [
                        { icon: <Folder size={16} className="text-sidebar-foreground" />, label: "All folders" },
                        { icon: <Archive size={16} className="text-sidebar-foreground" />, label: "Archived files" },
                    ],
                },
            ],
        },
            ...
            sections: [
                {
                    title: "Account",
                    items: [
                        { icon: <UserIcon size={16} className="text-sidebar-foreground" />, label: "Profile settings" },
                    ...
                    items: [
                        {
                            ...
                            hasDropdown: true,
                            children: [
                                { icon: <View size={14} className="text-sidebar-foreground/70" />, label: "Theme settings" },
                                { icon: <Time size={14} className="text-sidebar-foreground/70" />, label: "Time zone" },
                                { icon: <Notification size={14} className="text-sidebar-foreground/70" />, label: "Default notifications" },
                            ],
                        },
                        { icon: <Integration size={16} className="text-sidebar-foreground" />, label: "Integrations" },
                    ],
                },
            ],
        },
...
function IconNavButton({
    ...
    return (
        ...
        ${isActive ? "bg-sidebar-accent text-sidebar-foreground" : "hover:bg-sidebar-accent text-sidebar-foreground/60 hover:text-sidebar-foreground/70"}`}
            style={{ transitionTimingFunction: softSpringEasing }}
            onClick={onClick}
        >
            {children}
...
function IconNavigation({
    ...
    return (
        <aside className="bg-sidebar flex flex-col gap-2 items-center p-4 w-16 h-full border-r border-sidebar-border rounded-l-2xl">
            {/* Logo */}
        ...
        return (
            <div className="w-full flex justify-center transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
                <button
                    ...
                    className="flex items-center justify-center rounded-lg size-10 min-w-10 transition-all duration-500 hover:bg-sidebar-accent text-sidebar-foreground/60 hover:text-sidebar-foreground/70"
                    style={{ transitionTimingFunction: softSpringEasing }}
        ...
        <div className="w-full overflow-hidden transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
            <div className="flex items-center justify-between">
                <div className="flex items-center h-10">
                    <div className="px-2 py-1">
                        <div className="font-['Lexend:SemiBold',_sans-serif] text-[18px] text-sidebar-foreground leading-[27px]">
                            {title}
                        </div>
                    </div>
                </div>
...
function DetailSidebar({ activeSection }: { activeSection: string }) {
    ...
    return (
        <aside
            className={`bg-sidebar flex flex-col gap-4 items-start p-4 rounded-r-2xl transition-all duration-500 h-full ${isCollapsed ? "w-16 min-w-16 !px-0 justify-center" : "w-80"
                }`}
            style={{ transitionTimingFunction: softSpringEasing }}
        >
            ...
            <div
                className={`flex flex-col w-full min-h-0 flex-1 overflow-y-auto transition-all duration-500 ${isCollapsed ? "gap-2 items-center" : "gap-4 items-start"
                    }`}
                style={{ transitionTimingFunction: softSpringEasing }}
            >
            ...
            {!isCollapsed && (
                <div className="w-full mt-auto pt-2 border-t border-sidebar-border">
                    <div className="flex items-center gap-2 px-2 py-2">
                        <AvatarCircle />
                        <div className="ml-2 font-['Lexend:Regular',_sans-serif] text-[14px] text-sidebar-foreground">Text content</div>
                        <button
                            type="button"
                            className="ml-auto size-8 rounded-md flex items-center justify-center hover:bg-sidebar-accent"
                            aria-label="More"
                        >
                            <svg className="size-4 text-sidebar-foreground" viewBox="0 0 16 16" fill="none">
...
function MenuItem({
    ...
    return (
        ...
        >
            <div
                className={`rounded-lg cursor-pointer transition-all duration-500 flex items-center relative ${item.isActive ? "bg-sidebar-accent" : "hover:bg-sidebar-accent"
            ...
            >
                ...
                <div
                    ...
                    style={{ transitionTimingFunction: softSpringEasing }}
                >
                    <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-sidebar-foreground leading-[20px] truncate">
                        {item.label}
                    </div>
                </div>
                ...
                {item.hasDropdown && (
                    ...
                    >
                        <ChevronDownIcon
                            size={16}
                            className="text-sidebar-foreground transition-transform duration-500"
                            style={{
...
function SubMenuItem({ item, onItemClick }: { item: MenuItemT; onItemClick?: () => void }) {
    return (
        <div className="w-full pl-9 pr-1 py-[1px]">
            <div
                className="h-10 w-full rounded-lg cursor-pointer transition-colors hover:bg-sidebar-accent flex items-center px-3 py-1"
                onClick={onItemClick}
            >
                <div className="flex-1 min-w-0">
                    <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-sidebar-foreground/70 leading-[18px] truncate">
                        {item.label}
                    </div>
                </div>
            </div>
        ...
        <div className="flex flex-col w-full">
            ...
            >
                <div className="flex items-center h-10 px-4">
                    <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-sidebar-foreground/60">
                        {section.title}
                    </div>
                </div>
            </div>
